        ...
        <header className="mb-14 border-b border-white/10 pb-8">
          <div className="flex flex-wrap items-center justify-between gap-6">
            ...
            <nav className="flex items-center gap-2 text-sm">
              <Link href="/" className="rounded-full border border-white/15 px-4 py-2 text-neutral-200 transition hover:border-white/40 hover:bg-white/5">
                Journal
              </Link>
              <Link href="/admin" className="rounded-full border border-cyan-400/30 bg-cyan-400/10 px-4 py-2 text-cyan-100 transition hover:bg-cyan-400/20">
                Workspace
              </Link>
            </nav>
          </div>
